  ...
  try {
    ...
    monaco.editor.defineTheme("vizsga-light", {
      ...
      rules: [
        ...
        // HTML tokenek
        { token: "tag", foreground: "000099", fontStyle: "bold" },
        { token: "tag.html", foreground: "000099", fontStyle: "bold" },
        { token: "delimiter", foreground: "000000" },
        { token: "delimiter.html", foreground: "000000" },
        { token: "attribute.name", foreground: "7B0000", fontStyle: "bold" },
        { token: "attribute.name.html", foreground: "7B0000", fontStyle: "bold" },
        { token: "attribute.value", foreground: "005200", fontStyle: "bold" },
        { token: "attribute.value.html", foreground: "005200", fontStyle: "bold" },
        { token: "string", foreground: "005200", fontStyle: "bold" },
        { token: "string.html", foreground: "005200", fontStyle: "bold" },
        { token: "comment", foreground: "444444", fontStyle: "italic" },
        { token: "comment.html", foreground: "444444", fontStyle: "italic" },
        // CSS tokenek
        { token: "keyword.css", foreground: "7B0000", fontStyle: "bold" },
        { token: "attribute.value.css", foreground: "005200", fontStyle: "bold" },
        { token: "attribute.value.number.css", foreground: "8B0000", fontStyle: "bold" },
        { token: "attribute.value.unit.css", foreground: "8B0000" },
        { token: "string.css", foreground: "005200", fontStyle: "bold" },
        { token: "comment.css", foreground: "444444", fontStyle: "italic" },
        { token: "selector.css", foreground: "000099", fontStyle: "bold" },
        // Általános
        { token: "keyword", foreground: "000099", fontStyle: "bold" },
        { token: "number", foreground: "8B0000", fontStyle: "bold" },
        { token: "string", foreground: "005200", fontStyle: "bold" },
      ],
      colors: {
